...
--MAXLOGHISTORY 500
NOARCHIVELOG
    DATAFILE 'system/system001.dtf' SIZE 300M
    UNDO TABLESPACE UNDO0 DATAFILE 'system/undo001.dtf' SIZE 300M
    DEFAULT TEMPORARY TABLESPACE TEMP TEMPFILE 'system/temp001.dtf' SIZE 300M
    DEFAULT TABLESPACE USR DATAFILE 'system/usr001.dtf' SIZE 300M
